...
export const metadata: Metadata = {
  ...
  title: {
    default: "Rahul Rathod | Full Stack Developer",
    template: `%s | Rahul Rathod`,
  },
  description: "Rahul Rathod is a Full Stack Developer from India, with expertise in React, Next.js, TypeScript and Node.js. I create modern web applications and have a passion for clean, efficient code. View my portfolio to see my latest projects and technical blog posts.",
  keywords: ["Rahul Rathod", "Full Stack Developer", "React Developer", "Next.js Developer", "TypeScript Developer", "Node.js Developer", "Web Developer India", "Software Engineer"],
  ...
  openGraph: {
    ...
    url: DATA.url,
    siteName: "Rahul Rathod - Portfolio",
    locale: "en_US",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Rahul Rathod - Full Stack Developer"
      }
    ]
  },
  twitter: {
